...
import com.f2c.social.social.ConnectionSignUpImpl;
...
public class SocialConfig implements SocialConfigurer {
	...
	public void addConnectionFactories(ConnectionFactoryConfigurer cfConfig, Environment env) {
		...
		/*
		 * // Twitter TwitterConnectionFactory tfactory = new
		 * TwitterConnectionFactory(// env.getProperty("twitter.consumer.key"), //
